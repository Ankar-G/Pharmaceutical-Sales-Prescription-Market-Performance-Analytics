...
🔄 Project Workflow
Data Collection — Organized eight relational tables covering customers, doctors, products, sales, prescriptions, distributors, territories, and dates.
Data Validation (SQL) — Checked record counts, duplicates, NULLs, and referential integrity across tables.
Data Analysis (SQL) — Queried sales, product, prescription, and territory data to surface performance patterns.
Data Modeling (Power BI) — Built a relational data model connecting all tables through common keys.
DAX Measures — Created KPI and analytical measures for revenue, profit, prescriptions, and target achievement.
Dashboard Development — Designed four dashboards covering executive, product, doctor, and territory/distributor views.
Insight Generation — Interpreted the visuals to produce clear, business-relevant takeaways.
...
Product Profitability Matrix / Analysis
Revenue by Therapy Area
Prescription Volume by Therapy Area
...
Top 10 Doctors by Prescription Volume
Top 10 Doctors by Revenue
Prescriptions by Specialty
Revenue by Specialty
Doctor Prescription → Sales Analysis
Monthly Prescription Trend
Product Preference by Specialty Matrix
...
Distributor Revenue Ranking
Distributor Performance by Region
Monthly Regional Sales Trend
Sales Opportunity / Underperforming Territory Analysis (scatter chart)
...
What is the total pharmaceutical revenue and profit?
Which therapy areas generate the most revenue?
Which products are the strongest revenue and profit contributors?
Which products have low sales performance?
How are prescription volumes changing over time?
Which doctors generate the highest prescription volumes?
Which specialties contribute the most revenue?
Which regions generate the highest sales?
Which territories are meeting or missing their targets?
Which distributors contribute the most revenue?
Where are the potential sales opportunities?
Which territories require closer performance monitoring?
🛠️ Tech Stack
Tool	Purpose
...
Create a folder named Screenshots/ in the root of the repository.
Add the four dashboard screenshots using the exact filenames listed above.
Keep the relative paths (Screenshots/filename.png) as used in this README — do not use absolute local file paths.
Confirm the images render correctly by previewing the README on GitHub before finalizing.
🤝 Connect With Me
